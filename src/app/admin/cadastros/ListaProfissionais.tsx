...
import { criarProfissional, atualizarProfissional, excluirProfissional } from './actions';
import { confirmarExclusaoDupla } from '@/lib/confirmar';
import type { Profissional } from '@/lib/viagens-ipm';
...
function LinhaEditavel({ item }: { item: Profissional }) {
...
export default function ListaProfissionais({ itens }: { itens: Profissional[] }) {
  const [estado, formAction] = useActionState(criarProfissional, undefined);
